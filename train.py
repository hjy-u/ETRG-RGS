...
# changed rgbd features to all depth -> bias at multiprojector

def get_parser():
    parser = argparse.ArgumentParser(
        description='Pytorch Referring Grasp Synthesis')
    parser.add_argument('--config',
                        default='config/OCID-VLG/etrg_r50.yaml',
                        type=str,
                        help='config file')
...
def main_worker(gpu, args):
    ...
    # build model
    model, param_list = build_depth_mhsa(args)
